export const problems = [
  ...
  },
  {
    ...
    approach:
      "Convert both arrays into unordered sets (set1 and set2) to ensure distinct elements.\nUse count() for checking the existence of elements in the other set (more concise than find()).\nPush the elements into ans1 and ans2 based on their presence in the opposite set.",
  },
  {
    id: 4,
